...
class ConfigChainFactory:
    ...
    def create_config_chain(self, instance_name=None, env_var_names=None, config_property_names=None, default=None, conversion_func=None):
