...
from botocore.docs.method import document_custom_method, document_model_driven_method, get_instance_public_methods
...
class ClientExceptionsDocumenter:
    _USER_GUIDE_LINK = 'https://docs.aws.amazon.com/boto3/latest/guide/error-handling.html'
...
class ClientContextParamsDocumenter:
    _CONFIG_GUIDE_LINK = 'https://docs.aws.amazon.com/boto3/latest/guide/configuration.html'
