...
from urllib3.exceptions import LocationParseError, NewConnectionError, ProtocolError, ProxyError
from urllib3.exceptions import ReadTimeoutError as URLLib3ReadTimeoutError
from urllib3.exceptions import SSLError as URLLib3SSLError
from urllib3.poolmanager import PoolKey
from urllib3.util.retry import Retry
from urllib3.util.ssl_ import OP_NO_COMPRESSION, PROTOCOL_TLS, OP_NO_SSLv2, OP_NO_SSLv3, is_ipaddress, ssl
...
from botocore.compat import IPV6_ADDRZ_RE, ensure_bytes, filter_ssl_warnings, unquote, urlparse
from botocore.exceptions import ConnectionClosedError, ConnectTimeoutError, EndpointConnectionError, HTTPClientError, InvalidProxiesConfigError, ProxyConnectionError, ReadTimeoutError, SSLError
filter_ssl_warnings()
...
class URLLib3Session:
    ...
    def __init__(self, verify=True, proxies=None, timeout=None, max_pool_connections=MAX_POOL_CONNECTIONS, socket_options=None, client_cert=None, proxies_config=None):
        self._verify = verify
        self._proxy_config = ProxyConfiguration(proxies=proxies, proxies_settings=proxies_config)
        self._pool_classes_by_scheme = {'http': botocore.awsrequest.AWSHTTPConnectionPool, 'https': botocore.awsrequest.AWSHTTPSConnectionPool}
        if timeout is None:
    ...
    def send(self, request):
        try:
            ...
            http_response = botocore.awsrequest.AWSResponse(request.url, urllib_response.status, urllib_response.headers, urllib_response)
