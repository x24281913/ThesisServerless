...
class Loader:
    ...
    def __init__(self, extra_search_paths=None, file_loader=None, cache=None, include_default_search_paths=True, include_default_extras=True):
        self._cache = {}
    ...
    def load_service_model(self, service_name, type_name, api_version=None):
        ...
        if service_name not in known_services:
            raise UnknownServiceError(service_name=service_name, known_service_names=', '.join(known_services))
