...
from botocore.exceptions import ChecksumError, ConnectionClosedError, ConnectionError, EndpointConnectionError, ReadTimeoutError
...
class RetryHandler:
    ...
    def __call__(self, attempts, response, caught_exception, **kwargs):
        ...
        """
        checker_kwargs = {'attempt_number': attempts, 'response': response, 'caught_exception': caught_exception}
