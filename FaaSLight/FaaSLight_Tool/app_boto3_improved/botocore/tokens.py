...
from botocore.utils import CachedProperty, JSONFileCache, SSOTokenLoader, create_nested_client, get_token_from_environment
...
def create_token_resolver(session):
    providers = [ScopedEnvTokenProvider(session), SSOTokenProvider(session)]
