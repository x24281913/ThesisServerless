...
DOCUMENTATION_LINK_REGEX = re.compile('`AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/[a-z0-9-.]*/[a-zA-Z]*>`_')
LARGE_SECTION_MESSAGE = '\n\n    **{}**\n    ::\n\n        # This section is too large to render.\n        # Please see the AWS API Documentation linked below.\n\n    {}\n    '
LOG = logging.getLogger('bcdocs')
SECTION_LINE_LIMIT_CONFIG = {'response-example': {'name': 'Response Syntax', 'line_limit': 1500}, 'description': {'name': 'Response Structure', 'line_limit': 5000}, 'request-example': {'name': 'Request Syntax', 'line_limit': 1500}, 'request-params': {'name': 'Parameters', 'line_limit': 5000}}
SECTION_METHOD_PATH_DEPTH = {'client-api': 4, 'paginator-api': 3, 'waiter-api': 3}
