...
from botocore.docs.client import ClientContextParamsDocumenter, ClientDocumenter, ClientExceptionsDocumenter
...
class ServiceDocumenter:
    ...
    def __init__(self, service_name, session, root_docs_path):
        ...
        self._client = self._session.create_client(service_name, region_name='us-east-1', aws_access_key_id='foo', aws_secret_access_key='bar')
        self._event_emitter = self._client.meta.events
        self.sections = ['title', 'client-api', 'client-exceptions', 'paginator-api', 'waiter-api', 'client-context-params']
