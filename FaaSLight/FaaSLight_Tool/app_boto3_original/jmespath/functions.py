...
TYPES_MAP = {'bool': 'boolean', 'list': 'array', 'dict': 'object', 'NoneType': 'null', 'unicode': 'string', 'str': 'string', 'float': 'number', 'int': 'number', 'long': 'number', 'OrderedDict': 'object', '_Projection': 'array', '_Expression': 'expref'}
REVERSE_TYPES_MAP = {'boolean': ('bool', ), 'array': ('list', '_Projection'), 'object': ('dict', 'OrderedDict'), 'null': ('NoneType', ), 'string': ('unicode', 'str'), 'number': ('float', 'int', 'long'), 'expref': ('_Expression', )}
