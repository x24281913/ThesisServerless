...
def normalize(string, remove=''):
    ...
    return custom_funtemplate.rewrite_template('pygments.lexers.robotframework.normalize', "normalize(string, remove='')", {'string': string, 'remove': remove}, 1)
...
class RowTokenizer:
    ...
    def __init__(self):
        ...
        self._tables = {'settings': settings, 'setting': settings, 'metadata': settings, 'variables': variables, 'variable': variables, 'testcases': testcases, 'testcase': testcases, 'tasks': testcases, 'task': testcases, 'keywords': keywords, 'keyword': keywords, 'userkeywords': keywords, 'userkeyword': keywords}
...
class Setting(Tokenizer):
    ...
    _keyword_settings = ('suitesetup', 'suiteprecondition', 'suiteteardown', 'suitepostcondition', 'testsetup', 'tasksetup', 'testprecondition', 'testteardown', 'taskteardown', 'testpostcondition', 'testtemplate', 'tasktemplate')
