...
COLORS = {'bg': '#1d2331', 'blue_1': '#73D0FF', 'gray_1': '#7e8aa1', 'gray_2': '#3c4354', 'gray_3': '#6e7681', 'red_1': '#f88f7f', 'red_2': '#3d1e20', 'orange_1': '#FFAD66', 'orange_2': '#F29E74', 'yellow_1': '#FFD173', 'white': '#d4d2c8', 'magenta_1': '#DFBFFF', 'green_1': '#D5FF80', 'green_2': '#19362c', 'cyan_1': '#95E6CB'}
