...
_escape_html_table = {ord('&'): '&amp;', ord('<'): '&lt;', ord('>'): '&gt;', ord('"'): '&quot;', ord("'"): '&#39;'}
...
def webify(color):
    ...
    return custom_funtemplate.rewrite_template('pygments.formatters.html.webify', 'webify(color)', {'color': color}, 1)

def _get_ttype_class(ttype):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('pygments.formatters.html._get_ttype_class', '_get_ttype_class(ttype)', {'STANDARD_TYPES': STANDARD_TYPES, 'ttype': ttype}, 1)
...
"``,
    ...
    **Subclassing the HTML formatter**
    ...
    def get_linenos_style_defs(self):
        lines = [f'pre {{ {self._pre_style} }}', f'td.linenos .normal {{ {self._linenos_style} }}', f'span.linenos {{ {self._linenos_style} }}', f'td.linenos .special {{ {self._linenos_special_style} }}', f'span.linenos.special {{ {self._linenos_special_style} }}']
        return lines
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        yield (0, f'<table class="{self.cssclass}table">' + filename_tr + '<tr><td class="linenos"><div class="linenodiv"><pre>' + ls + '</pre></div></td><td class="code">')
        yield (0, '<div>')
