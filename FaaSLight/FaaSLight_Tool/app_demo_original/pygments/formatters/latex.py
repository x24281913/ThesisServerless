...
def _get_ttype_name(ttype):
    ...
    return custom_funtemplate.rewrite_template('pygments.formatters.latex._get_ttype_name', '_get_ttype_name(ttype)', {'STANDARD_TYPES': STANDARD_TYPES, 'ttype': ttype}, 1)
