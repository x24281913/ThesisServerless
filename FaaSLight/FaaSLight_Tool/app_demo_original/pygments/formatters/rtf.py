...
class RtfFormatter(Formatter):
    ...
    def _hl_open_str(self):
        return f'{{\\highlight{self.color_mapping[self.hl_color]} '
    
    @property
    def _rtf_header(self):
        lines = []
        lines.append('{\\rtf1\\ansi\\uc0\\deff0{\\fonttbl{\\f0\\fmodern\\fprq1\\fcharset0%s;}}' % (((self.fontface and ' ' + self._escape(self.fontface)) or '')))
