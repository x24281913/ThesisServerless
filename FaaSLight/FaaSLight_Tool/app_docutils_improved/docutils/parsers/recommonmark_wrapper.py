...
try:
    ...
    raise ImportError('Parsing "recommonmark" Markdown flavour requires the\n  package https://pypi.org/project/recommonmark.') from err
else:
    if recommonmark.__version__ < '0.6.0':
        raise ImportError('The installed version of "recommonmark" is too old. Update with "pip install -U recommonmark".')
