...
class Reader(Component):
    ...
    def __init__(self, parser: Parser | str | None = None, parser_name: str | None = None) -> None:
        ...
        if parser_name is not None:
            warnings.warn('Argument "parser_name" will be removed in Docutils 2.0.\n  Specify parser name in the "parser" argument.', PendingDeprecationWarning, stacklevel=2)
...
def get_reader_class(reader_name: str) -> type[Reader]:
    ...
    return custom_funtemplate.rewrite_template('docutils.readers.__init__.get_reader_class', 'get_reader_class(reader_name)', {'importlib': importlib, 'reader_name': reader_name, 'type': type, 'Reader': Reader}, 1)
