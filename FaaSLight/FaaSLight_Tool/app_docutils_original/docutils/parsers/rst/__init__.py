...
class Parser(docutils.parsers.Parser):
    ...
    def parse(self, inputstring, document) -> None:
        ...
        inputlines = docutils.statemachine.string2lines(inputstring, tab_width=document.settings.tab_width, convert_whitespace=True)
...
def convert_directive_function(directive_fn):
    ...
    return custom_funtemplate.rewrite_template('docutils.parsers.rst.__init__.convert_directive_function', 'convert_directive_function(directive_fn)', {'Directive': Directive, 'directive_fn': directive_fn}, 1)
