...
GLOBAL_ATTRIBUTES = ('class', 'dir', 'displaystyle', 'id', 'nonce', 'scriptlevel', 'style', 'tabindex')
...
class MathToken(MathElement):
    ...
    def __init__(self, text, **attributes) -> None:
        ...
        if not isinstance(text, (str, numbers.Number)):
            raise ValueError(f'MathToken element expects `str` or number, not "{text}".')
        self.text = str(text)
