...
WRITER_ALIASES = {'html': 'html4css1', 'html4': 'html4css1', 'xhtml10': 'html4css1', 'html5': 'html5_polyglot', 'xhtml': 'html5_polyglot', 's5': 's5_html', 'latex': 'latex2e', 'xelatex': 'xetex', 'luatex': 'xetex', 'lualatex': 'xetex', 'odf': 'odf_odt', 'odt': 'odf_odt', 'ooffice': 'odf_odt', 'openoffice': 'odf_odt', 'libreoffice': 'odf_odt', 'pprint': 'pseudoxml', 'pformat': 'pseudoxml', 'pdf': 'rlpdf', 'xml': 'docutils_xml'}

def get_writer_class(writer_name: str) -> type[Writer]:
    """Return the Writer class from the `writer_name` module."""
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('docutils.writers.__init__.get_writer_class', 'get_writer_class(writer_name)', {'WRITER_ALIASES': WRITER_ALIASES, 'importlib': importlib, 'writer_name': writer_name, 'type': type, 'Writer': Writer}, 1)
