...
FILL_PAT1 = re.compile('^ +')
FILL_PAT2 = re.compile(' {2,}')
TABLESTYLEPREFIX = 'rststyle-table-'
TABLENAMEDEFAULT = '%s0' % TABLESTYLEPREFIX
TABLEPROPERTYNAMES = ('border', 'border-top', 'border-left', 'border-right', 'border-bottom')
GENERATOR_DESC = 'Docutils.org/odf_odt'
NAME_SPACE_1 = 'urn:oasis:names:tc:opendocument:xmlns:office:1.0'
CONTENT_NAMESPACE_DICT = CNSD = {'chart': 'urn:oasis:names:tc:opendocument:xmlns:chart:1.0', 'dc': 'http://purl.org/dc/elements/1.1/', 'dom': 'http://www.w3.org/2001/xml-events', 'dr3d': 'urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0', 'draw': 'urn:oasis:names:tc:opendocument:xmlns:drawing:1.0', 'fo': 'urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0', 'form': 'urn:oasis:names:tc:opendocument:xmlns:form:1.0', 'math': 'http://www.w3.org/1998/Math/MathML', 'meta': 'urn:oasis:names:tc:opendocument:xmlns:meta:1.0', 'number': 'urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0', 'office': NAME_SPACE_1, 'ooo': 'http://openoffice.org/2004/office', 'oooc': 'http://openoffice.org/2004/calc', 'ooow': 'http://openoffice.org/2004/writer', 'presentation': 'urn:oasis:names:tc:opendocument:xmlns:presentation:1.0', 'script': 'urn:oasis:names:tc:opendocument:xmlns:script:1.0', 'style': 'urn:oasis:names:tc:opendocument:xmlns:style:1.0', 'svg': 'urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0', 'table': 'urn:oasis:names:tc:opendocument:xmlns:table:1.0', 'text': 'urn:oasis:names:tc:opendocument:xmlns:text:1.0', 'xforms': 'http://www.w3.org/2002/xforms', 'xlink': 'http://www.w3.org/1999/xlink', 'xsd': 'http://www.w3.org/2001/XMLSchema', 'xsi': 'http://www.w3.org/2001/XMLSchema-instance'}
STYLES_NAMESPACE_DICT = SNSD = {'chart': 'urn:oasis:names:tc:opendocument:xmlns:chart:1.0', 'dc': 'http://purl.org/dc/elements/1.1/', 'dom': 'http://www.w3.org/2001/xml-events', 'dr3d': 'urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0', 'draw': 'urn:oasis:names:tc:opendocument:xmlns:drawing:1.0', 'fo': 'urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0', 'form': 'urn:oasis:names:tc:opendocument:xmlns:form:1.0', 'math': 'http://www.w3.org/1998/Math/MathML', 'meta': 'urn:oasis:names:tc:opendocument:xmlns:meta:1.0', 'number': 'urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0', 'office': NAME_SPACE_1, 'presentation': 'urn:oasis:names:tc:opendocument:xmlns:presentation:1.0', 'ooo': 'http://openoffice.org/2004/office', 'oooc': 'http://openoffice.org/2004/calc', 'ooow': 'http://openoffice.org/2004/writer', 'script': 'urn:oasis:names:tc:opendocument:xmlns:script:1.0', 'style': 'urn:oasis:names:tc:opendocument:xmlns:style:1.0', 'svg': 'urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0', 'table': 'urn:oasis:names:tc:opendocument:xmlns:table:1.0', 'text': 'urn:oasis:names:tc:opendocument:xmlns:text:1.0', 'xlink': 'http://www.w3.org/1999/xlink'}
MANIFEST_NAMESPACE_DICT = MANNSD = {'manifest': 'urn:oasis:names:tc:opendocument:xmlns:manifest:1.0'}
META_NAMESPACE_DICT = METNSD = {'dc': 'http://purl.org/dc/elements/1.1/', 'meta': 'urn:oasis:names:tc:opendocument:xmlns:meta:1.0', 'office': NAME_SPACE_1, 'ooo': 'http://openoffice.org/2004/office', 'xlink': 'http://www.w3.org/1999/xlink'}
CONTENT_NAMESPACE_ATTRIB = {'xmlns:chart': 'urn:oasis:names:tc:opendocument:xmlns:chart:1.0', 'xmlns:dc': 'http://purl.org/dc/elements/1.1/', 'xmlns:dom': 'http://www.w3.org/2001/xml-events', 'xmlns:dr3d': 'urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0', 'xmlns:draw': 'urn:oasis:names:tc:opendocument:xmlns:drawing:1.0', 'xmlns:fo': 'urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0', 'xmlns:form': 'urn:oasis:names:tc:opendocument:xmlns:form:1.0', 'xmlns:math': 'http://www.w3.org/1998/Math/MathML', 'xmlns:meta': 'urn:oasis:names:tc:opendocument:xmlns:meta:1.0', 'xmlns:number': 'urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0', 'xmlns:office': NAME_SPACE_1, 'xmlns:presentation': 'urn:oasis:names:tc:opendocument:xmlns:presentation:1.0', 'xmlns:ooo': 'http://openoffice.org/2004/office', 'xmlns:oooc': 'http://openoffice.org/2004/calc', 'xmlns:ooow': 'http://openoffice.org/2004/writer', 'xmlns:script': 'urn:oasis:names:tc:opendocument:xmlns:script:1.0', 'xmlns:style': 'urn:oasis:names:tc:opendocument:xmlns:style:1.0', 'xmlns:svg': 'urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0', 'xmlns:table': 'urn:oasis:names:tc:opendocument:xmlns:table:1.0', 'xmlns:text': 'urn:oasis:names:tc:opendocument:xmlns:text:1.0', 'xmlns:xforms': 'http://www.w3.org/2002/xforms', 'xmlns:xlink': 'http://www.w3.org/1999/xlink', 'xmlns:xsd': 'http://www.w3.org/2001/XMLSchema', 'xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance'}
STYLES_NAMESPACE_ATTRIB = {'xmlns:chart': 'urn:oasis:names:tc:opendocument:xmlns:chart:1.0', 'xmlns:dc': 'http://purl.org/dc/elements/1.1/', 'xmlns:dom': 'http://www.w3.org/2001/xml-events', 'xmlns:dr3d': 'urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0', 'xmlns:draw': 'urn:oasis:names:tc:opendocument:xmlns:drawing:1.0', 'xmlns:fo': 'urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0', 'xmlns:form': 'urn:oasis:names:tc:opendocument:xmlns:form:1.0', 'xmlns:math': 'http://www.w3.org/1998/Math/MathML', 'xmlns:meta': 'urn:oasis:names:tc:opendocument:xmlns:meta:1.0', 'xmlns:number': 'urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0', 'xmlns:office': NAME_SPACE_1, 'xmlns:presentation': 'urn:oasis:names:tc:opendocument:xmlns:presentation:1.0', 'xmlns:ooo': 'http://openoffice.org/2004/office', 'xmlns:oooc': 'http://openoffice.org/2004/calc', 'xmlns:ooow': 'http://openoffice.org/2004/writer', 'xmlns:script': 'urn:oasis:names:tc:opendocument:xmlns:script:1.0', 'xmlns:style': 'urn:oasis:names:tc:opendocument:xmlns:style:1.0', 'xmlns:svg': 'urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0', 'xmlns:table': 'urn:oasis:names:tc:opendocument:xmlns:table:1.0', 'xmlns:text': 'urn:oasis:names:tc:opendocument:xmlns:text:1.0', 'xmlns:xlink': 'http://www.w3.org/1999/xlink'}
MANIFEST_NAMESPACE_ATTRIB = {'xmlns:manifest': 'urn:oasis:names:tc:opendocument:xmlns:manifest:1.0'}
META_NAMESPACE_ATTRIB = {'xmlns:dc': 'http://purl.org/dc/elements/1.1/', 'xmlns:meta': 'urn:oasis:names:tc:opendocument:xmlns:meta:1.0', 'xmlns:office': NAME_SPACE_1, 'xmlns:ooo': 'http://openoffice.org/2004/office', 'xmlns:xlink': 'http://www.w3.org/1999/xlink'}

def Element(tag, attrib=None, nsmap=None, nsdict=CNSD):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('docutils.writers.odf_odt.__init__.Element', 'Element(tag, attrib=None, nsmap=None, nsdict=CNSD)', {'fix_ns': fix_ns, '_ElementInterfaceWrapper': _ElementInterfaceWrapper, 'tag': tag, 'attrib': attrib, 'nsmap': nsmap, 'nsdict': nsdict, 'CNSD': CNSD}, 1)

def SubElement(parent, tag, attrib=None, nsmap=None, nsdict=CNSD):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('docutils.writers.odf_odt.__init__.SubElement', 'SubElement(parent, tag, attrib=None, nsmap=None, nsdict=CNSD)', {'fix_ns': fix_ns, '_ElementInterfaceWrapper': _ElementInterfaceWrapper, 'parent': parent, 'tag': tag, 'attrib': attrib, 'nsmap': nsmap, 'nsdict': nsdict, 'CNSD': CNSD}, 1)

def fix_ns(tag, attrib, nsdict):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('docutils.writers.odf_odt.__init__.fix_ns', 'fix_ns(tag, attrib, nsdict)', {'add_ns': add_ns, 'tag': tag, 'attrib': attrib, 'nsdict': nsdict}, 2)
...
def ToString(et):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('docutils.writers.odf_odt.__init__.ToString', 'ToString(et)', {'StringIO': StringIO, 'et': et}, 1)

def escape_cdata(text):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('docutils.writers.odf_odt.__init__.escape_cdata', 'escape_cdata(text)', {'text': text}, 1)
...
class Writer(writers.Writer):
    ...
    default_template_path = utils.relative_path(os.path.join(os.getcwd(), 'dummy'), os.path.join(os.path.dirname(__file__), default_template))
    ...
    def write_zip_str(self, zfile, name, bytes_, compress_type=zipfile.ZIP_DEFLATED) -> None:
    ...
    def create_manifest(self):
        root = Element('manifest:manifest', attrib=MANIFEST_NAMESPACE_ATTRIB, nsdict=MANIFEST_NAMESPACE_DICT)
        doc = ET.ElementTree(root)
        SubElement(root, 'manifest:file-entry', attrib={'manifest:media-type': self.MIME_TYPE, 'manifest:full-path': '/'}, nsdict=MANNSD)
        SubElement(root, 'manifest:file-entry', attrib={'manifest:media-type': 'text/xml', 'manifest:full-path': 'content.xml'}, nsdict=MANNSD)
        SubElement(root, 'manifest:file-entry', attrib={'manifest:media-type': 'text/xml', 'manifest:full-path': 'styles.xml'}, nsdict=MANNSD)
        SubElement(root, 'manifest:file-entry', attrib={'manifest:media-type': 'text/xml', 'manifest:full-path': 'settings.xml'}, nsdict=MANNSD)
        SubElement(root, 'manifest:file-entry', attrib={'manifest:media-type': 'text/xml', 'manifest:full-path': 'meta.xml'}, nsdict=MANNSD)
        s1 = ToString(doc)
...
class ODFTranslator(nodes.GenericNodeVisitor):
        ...
        for stylenode in auto_styles:
            ...
            if name.startswith(TABLESTYLEPREFIX):
                ...
                if family == 'table':
                    ...
                    property_ = properties.get('{%s}%s' % (CNSD['fo'], 'background-color'))
    ...
    def get_image_width_height(self, node, attr):
        ...
        if attr in node.attributes:
            ...
            try:
                ...
                self.document.reporter.warning(f'Invalid {attr} for image: "{node.attributes[attr]}".  Error: "{exp}".', base_node=node)
                (size, unit) = (0.5, 'cm')
        return (size, unit)
    ...
    def get_image_scaled_width_height(self, node, source):
        ...
        if (width is None or height is None):
            ...
            try:
                ...
                dpi = (dpi, dpi)
        if width is None:
            width = img_size[0] * 0.026
        if (height is None and width_unit != '%'):
            height = img_size[1] * 0.026
        if width_unit == '%':
            factor = width
            line_width = self.get_page_width()
            width = factor * line_width
            if height is None:
                image_width = img_size[0] * 0.026
                image_height = img_size[1] * 0.026
    ...
    def get_table_style(self, node):
        ...
        if table_name is not None:
            ...
            if table_style is None:
                self.document.reporter.warning(f"""Can\'t find table style "{table_name}".  Using default.""", base_node=node)
                table_name = TABLENAMEDEFAULT
                table_style = self.table_styles.get(table_name)
                if table_style is None:
                    self.document.reporter.warning(f"""Can\'t find default table style "{table_name}".  Using built-in default.""", base_node=node)
                    table_style = BUILTIN_DEFAULT_TABLE_STYLE
        else:
            table_name = TABLENAMEDEFAULT
            table_style = self.table_styles.get(table_name)
            if table_style is None:
                self.document.reporter.warning('Can\'t find default table style "{table_name}".  Using built-in default.', base_node=node)
                table_style = BUILTIN_DEFAULT_TABLE_STYLE
        return table_style
    ...
    def visit_title(self, node, move_ids=1, title_type='title') -> None:
        if isinstance(node.parent, docutils.nodes.section):
            ...
            if section_level > 7:
                self.document.reporter.warning('Heading/section levels greater than 7 not supported.    Reducing to heading level 7 for heading: "%s"' % (node.astext(), ), base_node=node)
                section_level = 7
