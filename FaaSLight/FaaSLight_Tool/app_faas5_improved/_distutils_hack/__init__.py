...
def warn_distutils_present():
    ...
    return custom_funtemplate.rewrite_template('_distutils_hack.__init__.warn_distutils_present', 'warn_distutils_present()', {'sys': sys, 'is_pypy': is_pypy}, 1)

def clear_distutils():
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('_distutils_hack.__init__.clear_distutils', 'clear_distutils()', {'sys': sys}, 1)
...
def remove_shim():
    import custom_funtemplate
    custom_funtemplate.rewrite_template('_distutils_hack.__init__.remove_shim', 'remove_shim()', {'sys': sys, 'DISTUTILS_FINDER': DISTUTILS_FINDER}, 0)
