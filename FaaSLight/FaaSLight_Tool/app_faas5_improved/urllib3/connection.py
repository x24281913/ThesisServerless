...
def _match_hostname(cert, asserted_hostname):
    ...
    custom_funtemplate.rewrite_template('urllib3.connection._match_hostname', '_match_hostname(cert, asserted_hostname)', {'is_ipaddress': is_ipaddress, 'match_hostname': match_hostname, 'CertificateError': CertificateError, 'log': log, 'cert': cert, 'asserted_hostname': asserted_hostname}, 0)
