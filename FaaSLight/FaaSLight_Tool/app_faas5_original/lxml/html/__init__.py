...
def _unquote_match(s, pos):
    ...
    return custom_funtemplate.rewrite_template('lxml.html.__init__._unquote_match', '_unquote_match(s, pos)', {'s': s, 'pos': pos}, 2)

def _transform_result(typ, result):
    """Convert the result back into the input type.
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('lxml.html.__init__._transform_result', '_transform_result(typ, result)', {'tostring': tostring, 'unicode': unicode, 'typ': typ, 'result': result}, 1)
...
def fragments_fromstring(html, no_leading_text=False, base_url=None, parser=None, **kw):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('lxml.html.__init__.fragments_fromstring', 'fragments_fromstring(html, no_leading_text=False, base_url=None, parser=None, **kw)', {'html_parser': html_parser, '_looks_like_full_html_bytes': _looks_like_full_html_bytes, '_looks_like_full_html_unicode': _looks_like_full_html_unicode, 'document_fromstring': document_fromstring, '_nons': _nons, 'etree': etree, 'html': html, 'no_leading_text': no_leading_text, 'base_url': base_url, 'parser': parser, 'kw': kw}, 1)
...
def fragment_fromstring(html, create_parent=False, base_url=None, parser=None, **kw):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('lxml.html.__init__.fragment_fromstring', 'fragment_fromstring(html, create_parent=False, base_url=None, parser=None, **kw)', {'html_parser': html_parser, 'fragments_fromstring': fragments_fromstring, 'basestring': basestring, 'Element': Element, 'etree': etree, '_element_name': _element_name, 'html': html, 'create_parent': create_parent, 'base_url': base_url, 'parser': parser, 'kw': kw}, 1)
...
def parse(filename_or_url, parser=None, base_url=None, **kw):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('lxml.html.__init__.parse', 'parse(filename_or_url, parser=None, base_url=None, **kw)', {'html_parser': html_parser, 'etree': etree, 'filename_or_url': filename_or_url, 'parser': parser, 'base_url': base_url, 'kw': kw}, 1)
...
def _element_name(el):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('lxml.html.__init__._element_name', '_element_name(el)', {'etree': etree, 'basestring': basestring, '_nons': _nons, 'el': el}, 1)
...
def submit_form(form, extra_values=None, open_http=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('lxml.html.__init__.submit_form', 'submit_form(form, extra_values=None, open_http=None)', {'open_http_urllib': open_http_urllib, 'form': form, 'extra_values': extra_values, 'open_http': open_http}, 1)

def open_http_urllib(method, url, values):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('lxml.html.__init__.open_http_urllib', 'open_http_urllib(method, url, values)', {'method': method, 'url': url, 'values': values}, 1)
...
def html_to_xhtml(html):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('lxml.html.__init__.html_to_xhtml', 'html_to_xhtml(html)', {'XHTML_NAMESPACE': XHTML_NAMESPACE, 'etree': etree, 'html': html}, 0)
...
def xhtml_to_html(xhtml):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('lxml.html.__init__.xhtml_to_html', 'xhtml_to_html(xhtml)', {'XHTML_NAMESPACE': XHTML_NAMESPACE, 'xhtml': xhtml}, 0)
...
def tostring(doc, pretty_print=False, include_meta_content_type=False, encoding=None, method='html', with_tail=True, doctype=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('lxml.html.__init__.tostring', "tostring(doc, pretty_print=False, include_meta_content_type=False, encoding=None, method='html', with_tail=True, doctype=None)", {'etree': etree, '__str_replace_meta_content_type': __str_replace_meta_content_type, '__bytes_replace_meta_content_type': __bytes_replace_meta_content_type, 'doc': doc, 'pretty_print': pretty_print, 'include_meta_content_type': include_meta_content_type, 'encoding': encoding, 'method': method, 'with_tail': with_tail, 'doctype': doctype}, 1)
...
def open_in_browser(doc, encoding=None):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('lxml.html.__init__.open_in_browser', 'open_in_browser(doc, encoding=None)', {'etree': etree, 'doc': doc, 'encoding': encoding}, 0)
