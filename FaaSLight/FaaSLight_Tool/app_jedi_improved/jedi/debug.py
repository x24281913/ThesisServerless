...
def reset_time():
    ...
    custom_funtemplate.rewrite_template('jedi.debug.reset_time', 'reset_time()', {'time': time}, 0)
...
def print_to_stdout(color, str_out):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('jedi.debug.print_to_stdout', 'print_to_stdout(color, str_out)', {'Fore': Fore, '_lazy_colorama_init': _lazy_colorama_init, 'color': color, 'str_out': str_out}, 0)
