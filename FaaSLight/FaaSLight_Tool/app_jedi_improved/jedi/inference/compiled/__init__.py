from jedi.inference.compiled.value import CompiledValue, CompiledName, CompiledValueFilter, CompiledValueName, create_from_access_path
...
def create_simple_object(inference_state, obj):
    ...
    compiled_value = create_from_access_path(inference_state, inference_state.compiled_subprocess.create_simple_object(obj))
