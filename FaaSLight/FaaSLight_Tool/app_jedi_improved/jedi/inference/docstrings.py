...
def _search_param_in_numpydocstr(docstr, param_str):
    ...
    return custom_funtemplate.rewrite_template('jedi.inference.docstrings._search_param_in_numpydocstr', '_search_param_in_numpydocstr(docstr, param_str)', {'warnings': warnings, '_get_numpy_doc_string_cls': _get_numpy_doc_string_cls, 're': re, '_expand_typestr': _expand_typestr, 'docstr': docstr, 'param_str': param_str}, 1)
...
def _search_param_in_docstr(docstr, param_str):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('jedi.inference.docstrings._search_param_in_docstr', '_search_param_in_docstr(docstr, param_str)', {'re': re, 'DOCSTRING_PARAM_PATTERNS': DOCSTRING_PARAM_PATTERNS, '_strip_rst_role': _strip_rst_role, '_search_param_in_numpydocstr': _search_param_in_numpydocstr, 'docstr': docstr, 'param_str': param_str}, 1)
...
def infer_param(function_value, param):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('jedi.inference.docstrings.infer_param', 'infer_param(function_value, param)', {'ValueSet': ValueSet, '_search_param_in_docstr': _search_param_in_docstr, '_infer_for_statement_string': _infer_for_statement_string, 'NO_VALUES': NO_VALUES, 'debug': debug, 'inference_state_method_cache': inference_state_method_cache, 'function_value': function_value, 'param': param}, 1)
