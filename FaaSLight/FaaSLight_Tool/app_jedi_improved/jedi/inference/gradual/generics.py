...
def _resolve_forward_references(context, value_set):
    ...
    custom_funtemplate.rewrite_template('jedi.inference.gradual.generics._resolve_forward_references', '_resolve_forward_references(context, value_set)', {'is_string': is_string, 'context': context, 'value_set': value_set}, 0)
