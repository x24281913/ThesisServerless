...
def load_module_from_path(inference_state, file_io, import_names=None, is_package=None):
    ...
    return custom_funtemplate.rewrite_template('jedi.inference.imports.load_module_from_path', 'load_module_from_path(inference_state, file_io, import_names=None, is_package=None)', {'Path': Path, 'sys_path': sys_path, 'FolderIO': FolderIO, 'load_module_from_path': load_module_from_path, 'ValueSet': ValueSet, 'NO_VALUES': NO_VALUES, 'create_stub_module': create_stub_module, 'parse_stub_module': parse_stub_module, '_load_python_module': _load_python_module, 'inference_state': inference_state, 'file_io': file_io, 'import_names': import_names, 'is_package': is_package}, 1)

def load_namespace_from_path(inference_state, folder_io):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('jedi.inference.imports.load_namespace_from_path', 'load_namespace_from_path(inference_state, folder_io)', {'sys_path': sys_path, 'Path': Path, 'inference_state': inference_state, 'folder_io': folder_io}, 1)
