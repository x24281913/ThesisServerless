...
def execution_recursion_decorator(default=NO_VALUES):
    ...
    def decorator(func):
        ...
        def wrapper(self, **kwargs):
            ...
            return custom_funtemplate.rewrite_template('jedi.inference.recursion.execution_recursion_decorator.decorator.wrapper', 'wrapper(self, **kwargs)', {'default': default, 'func': func, 'self': self, 'kwargs': kwargs}, 1)
        return wrapper
    return decorator
