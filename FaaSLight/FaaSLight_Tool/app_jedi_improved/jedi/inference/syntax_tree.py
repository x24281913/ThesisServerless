...
def _limit_value_infers(func):
    ...
    def wrapper(context, *args, **kwargs):
        ...
        return custom_funtemplate.rewrite_template('jedi.inference.syntax_tree._limit_value_infers.wrapper', 'wrapper(context, *args, **kwargs)', {'debug': debug, 'NO_VALUES': NO_VALUES, 'func': func, 'context': context, 'args': args, 'kwargs': kwargs}, 1)
    return wrapper
        ...
        for name in names:
            ...
            if (expr_stmt.type == 'expr_stmt' and expr_stmt.children[1].type == 'annassign'):
                ...
                if correct_scope:
                    ...
                    if (ann_assign.children[1].type == 'name' and ann_assign.children[1].value == tree_name.value and context.parent_context):
