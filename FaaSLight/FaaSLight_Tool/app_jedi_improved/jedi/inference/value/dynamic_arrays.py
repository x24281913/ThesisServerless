...
def get_dynamic_array_instance(instance, arguments):
    ...
    return custom_funtemplate.rewrite_template('jedi.inference.value.dynamic_arrays.get_dynamic_array_instance', 'get_dynamic_array_instance(instance, arguments)', {'_DynamicArrayAdditions': _DynamicArrayAdditions, 'ValueSet': ValueSet, 'instance': instance, 'arguments': arguments}, 1)
