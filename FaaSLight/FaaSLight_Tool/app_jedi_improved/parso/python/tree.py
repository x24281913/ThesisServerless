...
def _create_params(parent, argslist_list):
    ...
    return custom_funtemplate.rewrite_template('parso.python.tree._create_params', '_create_params(parent, argslist_list)', {'Param': Param, 'parent': parent, 'argslist_list': argslist_list}, 1)
...
def _defined_names(current, include_setitem):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('parso.python.tree._defined_names', '_defined_names(current, include_setitem)', {'_defined_names': _defined_names, 'current': current, 'include_setitem': include_setitem}, 1)
