...
def preload_module(*modules):
    ...
    custom_funtemplate.rewrite_template('jedi.api.__init__.preload_module', 'preload_module(*modules)', {'Script': Script, 'modules': modules}, 0)
...
def set_debug_function(func_cb=debug.print_to_stdout, warnings=True, notices=True, speed=True):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('jedi.api.__init__.set_debug_function', 'set_debug_function(func_cb=debug.print_to_stdout, warnings=True, notices=True, speed=True)', {'debug': debug, 'func_cb': func_cb, 'warnings': warnings, 'notices': notices, 'speed': speed}, 0)
