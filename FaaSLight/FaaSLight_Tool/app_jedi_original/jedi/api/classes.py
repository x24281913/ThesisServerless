...
def defined_names(inference_state, value):
    ...
    return custom_funtemplate.rewrite_template('jedi.api.classes.defined_names', 'defined_names(inference_state, value)', {'HasNoContext': HasNoContext, 'Name': Name, '_sort_names_by_start_pos': _sort_names_by_start_pos, 'inference_state': inference_state, 'value': value}, 1)
