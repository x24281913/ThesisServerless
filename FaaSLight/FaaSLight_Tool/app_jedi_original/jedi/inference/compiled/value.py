...
def _parse_function_doc(doc):
    ...
    return custom_funtemplate.rewrite_template('jedi.inference.compiled.value._parse_function_doc', '_parse_function_doc(doc)', {'debug': debug, 're': re, 'docstr_defaults': docstr_defaults, 'doc': doc}, 1)

def create_from_name(inference_state, compiled_value, name):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('jedi.inference.compiled.value.create_from_name', 'create_from_name(inference_state, compiled_value, name)', {'create_cached_compiled_value': create_cached_compiled_value, 'inference_state': inference_state, 'compiled_value': compiled_value, 'name': name}, 1)
