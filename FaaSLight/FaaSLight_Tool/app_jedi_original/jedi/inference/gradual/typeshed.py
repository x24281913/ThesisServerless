...
def import_module_decorator(func):
    ...
    def wrapper(inference_state, import_names, parent_module_value, sys_path, prefer_stubs):
        ...
        return custom_funtemplate.rewrite_template('jedi.inference.gradual.typeshed.import_module_decorator.wrapper', 'wrapper(inference_state, import_names, parent_module_value, sys_path, prefer_stubs)', {'ValueSet': ValueSet, 'settings': settings, 'try_to_load_stub_cached': try_to_load_stub_cached, 'wraps': wraps, 'func': func, 'inference_state': inference_state, 'import_names': import_names, 'parent_module_value': parent_module_value, 'sys_path': sys_path, 'prefer_stubs': prefer_stubs}, 1)
    return wrapper
