...
def _get_rhs_name(node, version):
    ...
    return custom_funtemplate.rewrite_template('parso.python.errors._get_rhs_name', '_get_rhs_name(node, version)', {'_get_comprehension_type': _get_comprehension_type, '_get_rhs_name': _get_rhs_name, '_remove_parens': _remove_parens, 'node': node, 'version': version}, 1)
...
def _iter_stmts(scope):
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('parso.python.errors._iter_stmts', '_iter_stmts(scope)', {'scope': scope}, 0)

def _get_comprehension_type(atom):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('parso.python.errors._get_comprehension_type', '_get_comprehension_type(atom)', {'_COMP_FOR_TYPES': _COMP_FOR_TYPES, 'atom': atom}, 1)
...
def _remove_parens(atom):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('parso.python.errors._remove_parens', '_remove_parens(atom)', {'_remove_parens': _remove_parens, 'atom': atom}, 1)
...
def _skip_parens_bottom_up(node):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('parso.python.errors._skip_parens_bottom_up', '_skip_parens_bottom_up(node)', {'node': node}, 1)
...
def _is_future_import_first(import_from):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('parso.python.errors._is_future_import_first', '_is_future_import_first(import_from)', {'_iter_stmts': _iter_stmts, '_is_future_import': _is_future_import, 'import_from': import_from}, 1)

def _iter_definition_exprs_from_lists(exprlist):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('parso.python.errors._iter_definition_exprs_from_lists', '_iter_definition_exprs_from_lists(exprlist)', {'_iter_definition_exprs_from_lists': _iter_definition_exprs_from_lists, '_STAR_EXPR_PARENTS': _STAR_EXPR_PARENTS, 'exprlist': exprlist}, 1)

def _get_expr_stmt_definition_exprs(expr_stmt):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('parso.python.errors._get_expr_stmt_definition_exprs', '_get_expr_stmt_definition_exprs(expr_stmt)', {'_iter_definition_exprs_from_lists': _iter_definition_exprs_from_lists, 'expr_stmt': expr_stmt}, 1)
...
def _any_fstring_error(version, node):
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('parso.python.errors._any_fstring_error', '_any_fstring_error(version, node)', {'version': version, 'node': node}, 1)
