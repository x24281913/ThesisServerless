...
class Grammar(Generic[_NodeT]):
    ...
    def parse(self, code: Union[(str, bytes)] = None, *, error_recovery=True, path: Union[(os.PathLike, str)] = None, start_symbol: str = None, cache=False, diff_cache=False, cache_path: Union[(os.PathLike, str)] = None, file_io: FileIO = None) -> _NodeT:
        """
