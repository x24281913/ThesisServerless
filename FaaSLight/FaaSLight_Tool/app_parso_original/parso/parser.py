...
def _token_to_transition(grammar, type_, value):
    ...
    return custom_funtemplate.rewrite_template('parso.parser._token_to_transition', '_token_to_transition(grammar, type_, value)', {'grammar': grammar, 'type_': type_, 'value': value}, 1)
