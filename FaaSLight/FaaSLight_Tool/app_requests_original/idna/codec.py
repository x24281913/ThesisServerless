...
def search_function(name: str) -> Optional[codecs.CodecInfo]:
    ...
    return custom_funtemplate.rewrite_template('idna.codec.search_function', 'search_function(name)', {'codecs': codecs, 'Codec': Codec, 'IncrementalEncoder': IncrementalEncoder, 'IncrementalDecoder': IncrementalDecoder, 'StreamWriter': StreamWriter, 'StreamReader': StreamReader, 'name': name, 'Optional': Optional, 'codecs': codecs}, 1)
