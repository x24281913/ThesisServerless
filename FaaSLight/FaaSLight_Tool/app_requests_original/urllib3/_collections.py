...
def ensure_can_construct_http_header_dict(potential: object) -> ValidHTTPHeaderSource | None:
    ...
    return custom_funtemplate.rewrite_template('urllib3._collections.ensure_can_construct_http_header_dict', 'ensure_can_construct_http_header_dict(potential)', {'HTTPHeaderDict': HTTPHeaderDict, 'typing': typing, 'potential': potential, 'ValidHTTPHeaderSource': ValidHTTPHeaderSource}, 1)
...
class HTTPHeaderDict(typing.MutableMapping[(str, str)]):
    ...
    def __init__(self, headers: ValidHTTPHeaderSource | None = None, **kwargs):
        super().__init__()
        self._container = {}
