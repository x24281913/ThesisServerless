...
def _default_key_normalizer(key_class: type[PoolKey], request_context: dict[(str, typing.Any)]) -> PoolKey:
    ...
    return custom_funtemplate.rewrite_template('urllib3.poolmanager._default_key_normalizer', '_default_key_normalizer(key_class, request_context)', {'_DEFAULT_BLOCKSIZE': _DEFAULT_BLOCKSIZE, 'key_class': key_class, 'request_context': request_context, 'type': type, 'PoolKey': PoolKey, 'dict': dict, 'str': str}, 1)
...
class PoolManager(RequestMethods):
    ...
    def __init__(self, num_pools: int = 10, headers: typing.Mapping[(str, str)] | None = None, **connection_pool_kw) -> None:
    ...
    def urlopen(self, method: str, url: str, redirect: bool = True, **kw) -> BaseHTTPResponse:
        """
