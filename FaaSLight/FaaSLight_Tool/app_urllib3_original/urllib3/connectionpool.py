...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    def __init__(self, host: str, port: int | None = None, timeout: _TYPE_TIMEOUT | None = _DEFAULT_TIMEOUT, maxsize: int = 1, block: bool = False, headers: typing.Mapping[(str, str)] | None = None, retries: Retry | bool | int | None = None, _proxy: Url | None = None, _proxy_headers: typing.Mapping[(str, str)] | None = None, _proxy_config: ProxyConfig | None = None, **conn_kw):
    ...
    def urlopen(self, method: str, url: str, body: _TYPE_BODY | None = None, headers: typing.Mapping[(str, str)] | None = None, retries: Retry | bool | int | None = None, redirect: bool = True, assert_same_host: bool = True, timeout: _TYPE_TIMEOUT = _DEFAULT_TIMEOUT, pool_timeout: int | None = None, release_conn: bool | None = None, chunked: bool = False, body_pos: _TYPE_BODY_POSITION | None = None, preload_content: bool = True, decode_content: bool = True, **response_kw) -> BaseHTTPResponse:
        """
...
def connection_from_url(url: str, **kw) -> HTTPConnectionPool:
    ...
    return custom_funtemplate.rewrite_template('urllib3.connectionpool.connection_from_url', 'connection_from_url(url, **kw)', {'parse_url': parse_url, 'port_by_scheme': port_by_scheme, 'HTTPSConnectionPool': HTTPSConnectionPool, 'HTTPConnectionPool': HTTPConnectionPool, 'url': url, 'kw': kw}, 1)
...
def _normalize_host(host: str | None, scheme: str | None) -> str | None:
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('urllib3.connectionpool._normalize_host', '_normalize_host(host, scheme)', {'normalize_host': normalize_host, 'host': host, 'scheme': scheme, 'str': str, 'str': str, 'str': str}, 1)
...
def _close_pool_connections(pool: queue.LifoQueue[typing.Any]) -> None:
    ...
    import custom_funtemplate
    custom_funtemplate.rewrite_template('urllib3.connectionpool._close_pool_connections', '_close_pool_connections(pool)', {'queue': queue, 'pool': pool, 'queue': queue, 'typing': typing}, 0)
