...
def inject_into_urllib3() -> None:
    ...
    custom_funtemplate.rewrite_template('urllib3.contrib.pyopenssl.inject_into_urllib3', 'inject_into_urllib3()', {'_validate_dependencies_met': _validate_dependencies_met, 'util': util, 'PyOpenSSLContext': PyOpenSSLContext}, 0)

def extract_from_urllib3() -> None:
    """Undo monkey-patching by :func:`inject_into_urllib3`."""
    import custom_funtemplate
    custom_funtemplate.rewrite_template('urllib3.contrib.pyopenssl.extract_from_urllib3', 'extract_from_urllib3()', {'util': util, 'orig_util_SSLContext': orig_util_SSLContext}, 0)
...
def _validate_dependencies_met() -> None:
    ...
    """
    import custom_funtemplate
    custom_funtemplate.rewrite_template('urllib3.contrib.pyopenssl._validate_dependencies_met', '_validate_dependencies_met()', {}, 0)
...
def _dnsname_to_stdlib(name: str) -> str | None:
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('urllib3.contrib.pyopenssl._dnsname_to_stdlib', '_dnsname_to_stdlib(name)', {'name': name, 'str': str}, 1)
...
def get_subj_alt_name(peer_cert: X509) -> list[tuple[(str, str)]]:
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('urllib3.contrib.pyopenssl.get_subj_alt_name', 'get_subj_alt_name(peer_cert)', {'x509': x509, 'UnsupportedExtension': UnsupportedExtension, 'log': log, '_dnsname_to_stdlib': _dnsname_to_stdlib, 'peer_cert': peer_cert, 'list': list, 'tuple': tuple}, 1)
