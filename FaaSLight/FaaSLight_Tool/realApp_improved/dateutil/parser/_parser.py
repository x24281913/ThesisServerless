...
def parse(timestr, parserinfo=None, **kwargs):
    ...
    return custom_funtemplate.rewrite_template('dateutil.parser._parser.parse', 'parse(timestr, parserinfo=None, **kwargs)', {'parser': parser, 'DEFAULTPARSER': DEFAULTPARSER, 'timestr': timestr, 'parserinfo': parserinfo, 'kwargs': kwargs}, 1)
