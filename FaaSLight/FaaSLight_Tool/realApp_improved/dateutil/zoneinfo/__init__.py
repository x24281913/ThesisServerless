...
def get_zonefile_instance(new_instance=False):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('dateutil.zoneinfo.__init__.get_zonefile_instance', 'get_zonefile_instance(new_instance=False)', {'get_zonefile_instance': get_zonefile_instance, 'ZoneInfoFile': ZoneInfoFile, 'getzoneinfofile_stream': getzoneinfofile_stream, 'new_instance': new_instance}, 1)
