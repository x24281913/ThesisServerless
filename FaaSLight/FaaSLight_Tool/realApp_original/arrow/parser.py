...
from typing import Any, ClassVar, Dict, Iterable, List, Literal, Match, Optional, Pattern, SupportsFloat, SupportsInt, Tuple, TypedDict, Union, cast, overload
try:
...
_FORMAT_TYPE = Literal[('YYYY', 'YY', 'MM', 'M', 'DDDD', 'DDD', 'DD', 'D', 'HH', 'H', 'hh', 'h', 'mm', 'm', 'ss', 's', 'X', 'x', 'ZZZ', 'ZZ', 'Z', 'S', 'W', 'MMMM', 'MMM', 'Do', 'dddd', 'ddd', 'd', 'a', 'A')]
...
class DateTimeParser:
    ...
    def _build_datetime(parts: _Parts) -> datetime:
        ...
        if expanded_timestamp is not None:
            return datetime.fromtimestamp(normalize_timestamp(expanded_timestamp), tz=timezone.utc)
