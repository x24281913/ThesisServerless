...
def __get_gettz():
    ...
    return custom_funtemplate.rewrite_template('dateutil.tz.tz.__get_gettz', '__get_gettz()', {'tzlocal': tzlocal, 'tzwinlocal': tzwinlocal, 'weakref': weakref, 'OrderedDict': OrderedDict, '_thread': _thread, 'os': os, 'TZFILES': TZFILES, 'TZPATHS': TZPATHS, 'tzfile': tzfile, 'IOError': IOError, 'six': six, 'tzwin': tzwin, 'tzstr': tzstr, 'UTC': UTC, 'time': time}, 1)
gettz = __get_gettz()
del __get_gettz
...
def datetime_exists(dt, tz=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('dateutil.tz.tz.datetime_exists', 'datetime_exists(dt, tz=None)', {'UTC': UTC, 'dt': dt, 'tz': tz}, 1)
...
def datetime_ambiguous(dt, tz=None):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('dateutil.tz.tz.datetime_ambiguous', 'datetime_ambiguous(dt, tz=None)', {'enfold': enfold, 'dt': dt, 'tz': tz}, 1)
...
def resolve_imaginary(dt):
    ...
    """
    import custom_funtemplate
    return custom_funtemplate.rewrite_template('dateutil.tz.tz.resolve_imaginary', 'resolve_imaginary(dt)', {'datetime_exists': datetime_exists, 'datetime': datetime, 'dt': dt}, 1)
...
if sys.version_info >= (3, 6):
    ...
    def _get_supported_offset(second_offset):
        import custom_funtemplate
        return custom_funtemplate.rewrite_template('dateutil.tz.tz._get_supported_offset', '_get_supported_offset(second_offset)', {'second_offset': second_offset}, 1)
try:
